...
import lineChart from "components/styles/linechart.png";
  ...
  renderGraphic() {
    switch (this.props.icon) {
      ...
      case "format-bold":
        return (
          <g>
            <path d="M15.6 10.79c.97-.67 1.65-1.77 1.65-2.79 0-2.26-1.75-4-4-4h-6.25v14h7.04c2.09
      ...
      case "format-underline":
        return (
          <g>
            <path d="M12 17c3.31 0 6-2.69 6-6v-8h-2.5v8c0 1.93-1.57 3.5-3.5
      ...
      case "format-align-left":
        return (
          <g>
            <path d="M15 15h-12v2h12v-2zm0-8h-12v2h12v-2zm-12
      ...
      case "add-box":
        return (
          <g>
            <path d="M19 3h-14c-1.11 0-2 .9-2 2v14c0 1.1.89 2 2 2h14c1.1 0 2-.9 2-2v-14c0-1.1-.9-2-2-2zm-2
      ...
      case "add":
        return (
          <g>
            <path d="M30 16h-6v6h-2v-6h-6v-2h6v-6h2v6h6v2z"></path>
          </g>
        );
      case "text-format":
        return (
          <g>
            <path d="M5 17v2h14v-2h-14zm4.5-4.2h5l.9 2.2h2.1l-4.75-11h-1.5l-4.75
      ...
      case "rotate":
        return (
          <g>
            <path d="M18.4 10.6c-1.85-1.61-4.25-2.6-6.9-2.6-4.65 0-8.58 3.03-9.96
      ...
      case "lineChart":
        return (<image xlinkHref={lineChart} style={{ width: "100%", height: "100%" }} />);
    }
  }
  render() {
    const styles = {
    ...
    return (
      <svg viewBox="0 0 50 50" onClick={this.props.onClick} preserveAspectRatio="xMidYMid meet" style={{ ...styles, ...this.props.style }}>
        {this.renderGraphic()}
      </svg>
    );
  }
