...
function ScaleAnchor(props) {
  ...
  return (
    <div style={[styles.anchor, styles.scaleAnchor, style]} className={'resize-anchor'} onMouseDown={props.onMouseDown}>
    </div>
    );
}
;
...
function RotateAnchor(props) {
  ...
  return (
    <div style={[styles.anchor, styles.rotateAnchor, style]} className={'rotate-anchor'} onMouseDown={props.onMouseDown}>
    </div>
  )
}
;
...
class Handler extends Component {
  ...
  render() {
    ...
    let handlerStyle = {
      ...styles.handler,
      ...boundingBox,
      left: boundingBox.left + 16,
      top: boundingBox.top + 1,
      transform: `rotate(${boundingBox.rotate}deg)`
    };

    return (
      <div className={'handler'} style={handlerStyle} onMouseLeave={props.onMouseLeave} onDoubleClick={props.onDoubleClick} onMouseDown={this.onMouseDown.bind(this)}>
        {props.canRotate &&
